    ...
    .controller('outliersCtrl', function($scope, $location, $sce, client, esFactory, ES_INDEX) {
        ...
        $scope.genVisualURL = function() {
            if($scope.user) {
                ...
                $scope.ip_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:ip,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.city_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:city,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.region_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:region,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.country_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:country,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.device_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:log.user=" + $scope.user + ")),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'3',params:(field:device.family,order:desc,orderBy:'1',size:5),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.model_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:device.model,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.brand_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:device.brand,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.os_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:os.family,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
                $scope.browser_visual_url = $sce.trustAsResourceUrl("http://163.28.17.48:5601/app/kibana#/visualize/edit/test?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:'" + $scope.logMgr.startDate + "',mode:quick,to:'" + $scope.logMgr.endDate + "'))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'log.user=" + $scope.user + "')),uiState:(),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(field:browser.family,order:desc,orderBy:'1',size:10),schema:segment,type:terms)),listeners:(),params:(addLegend:!t,addTooltip:!t,isDonut:!f,legendPosition:left,shareYAxis:!t),title:test,type:pie))");
            } else {
